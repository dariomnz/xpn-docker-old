...
timestamp=$(date +%s)
mpiexec -n 1 --output TAG-DETAILED -mca btl_base_verbose 100 \
        --map-by node:OVERSUBSCRIBE \
        --hostfile        /work/machines_mpi \
        --with-ft ulfm \
        ...
        /home/lab/src/ior/bin/ior -w -W -G ${timestamp} -r -R -o /tmp/expand/xpn/iortest1 -t 100k -b 100k -s 10 -i 1 -d 2 
# export XPN_DEBUG=1
# unset XPN_DEBUG
