...
export PATH=/home/lab/bin/mpich/bin:$PATH                      
export LD_LIBRARY_PATH=/home/lab/bin/mpich/lib:$LD_LIBRARY_PATH
...
# /home/lab/src/xpn/scripts/execute/xpn.sh -w /shared -l /work/machines_mpi -x /tmp -n $NL -v -p 1 start
/home/lab/src/xpn/scripts/execute/xpn.sh -w /shared -l /work/machines_mpi -x /tmp -n $NL -v mk_conf
# mpiexec --help
# mpiexec -np       $NL -disable-auto-cleanup \
#         --hostfile        /work/machines_mpi \
#         --map-by node \
...
(sleep 2 && mpiexec --host $(tail -n 1 /work/machines_mpi) pkill xpn_server) &

mpiexec -l -np 1 -disable-auto-cleanup \
        -hostfile        /work/machines_mpi \
